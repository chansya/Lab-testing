...
def is_mel(name, email):
    ...
    True
    >>> is_mel("John Joe","mel@ubermelon.com")
    True
    >>> is_mel("MEL","MEL@UBERMELON.COM")
    True
    >>> is_mel("MELARD MELITPOLSKI", "mel@UBERMELON.com")
    True
    """
...
def most_and_least_common_type(treats):
    ...
    >>> treats=[ {'type': 'appetizer'},  {'type': 'appetizer'},  {'type': 'appetizer'},{'type': 'dessert'},  {'type': 'drink'},{'type': 'drink'}]
    ...
    >>> treats=[ {'type': 'appetizer'},  {'type': 'appetizer'},  {'type': 'appetizer'},{'type': 'dessert'},  {'type': 'drink'},{'type': 'drink'},  {'type': 'dessert'},  {'type': 'dessert'}]
    >>> most_and_least_common_type(treats)
    ('appetizer', 'drink')
